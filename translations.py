...
TRANSLATIONS = {
    'en': {
        ...
        'how_support_helps': '💡 How Your Support Helps',
        'help_keep_free': 'Keep the app free for all users',
        'help_server_costs': 'Server hosting and maintenance costs',
        'help_ai_costs': 'AI API costs for quiz generation',
        'help_new_features': 'Development of new features',
        'help_content_updates': 'Content creation and updates',
    ...
    'ja': {
        ...
        'how_support_helps': '💡 サポートの使い道',
        'help_keep_free': 'すべてのユーザーにアプリを無料で提供',
        'help_server_costs': 'サーバーホスティングと保守費用',
        'help_ai_costs': 'クイズ生成のためのAI API費用',
        'help_new_features': '新機能の開発',
        'help_content_updates': 'コンテンツの作成と更新',
        'back_to_app': '← アプリに戻る',
        'n_back_test': 'N-backテスト（数字）',
        'may_take_time_to_load': '（読み込みに時間がかかる場合があります）',
        'privacy_policy_content': 'このアプリは、認証以外の個人情報を収集・共有しません。ユーザーデータはアプリ機能のためにのみ使用されます。このアプリを使用することで、個人学習目的でのみ使用することに同意したものとみなします。',
