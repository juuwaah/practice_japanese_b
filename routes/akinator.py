...
【意味不明・的外れな質問への対処】
以下のような質問には「わからない」または「いいえ」で回答してください：
- 複数の選択肢を含む質問（例：「大きい？それとも小さい？」「赤い？青い？」）→「わからない」
- 答えを直接要求する質問（例：「答えを教えて」「正解は何？」「何ですか？」）→「いいえ」
- 一意に定まらない質問（例：「どんな色？」「いくつある？」「どこにある？」）→「わからない」
- アキネーターが答えられない質問（例：「なぜ？」「どうして？」「理由は？」）→「わからない」
- 曖昧すぎる質問（例：「どう？」「そう？」「これ？」）→「わからない」
...
def build_akinator_gpt_prompt(history, level):
    ...
    prompt = (
        ...
        "- **重要：全ての質問は「はい」「いいえ」「わからない」「ときどき」で答えられる形式にしてください。**\n"
        "- 「何でできていますか？」「どこにありますか？」「いつ使いますか？」などの5W1H質問は禁止です。\n"
        "- 「〜でできていますか？」「〜にありますか？」「〜のときに使いますか？」のようにYes/No形式に変換してください。\n"
        ...
        "  - 「〜でできていますか？」（材質・構成）\n"
        "  - 「〜のときに使いますか？」（使用時期）\n"
        "- 禁止例：「何でできていますか？」「どこにありますか？」「いつ使いますか？」\n"
        "- 良い例：「金属でできていますか？」「家にありますか？」「毎日使いますか？」\n"
        "\n"
